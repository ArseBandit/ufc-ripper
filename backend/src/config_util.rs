...
pub struct UFCRConfig {
    ...
    pub auto_follow_replays: bool,
    pub auto_follow_ufc_number: u16,
    pub auto_follow_bjj_number: u16,
    pub auto_follow_contender_series: bool,
    pub auto_follow_fight_nights: bool,
    pub auto_follow_existing: bool,
...
impl Default for UFCRConfig {
    fn default() -> Self {
        UFCRConfig {
            ...
            auto_follow_replays: false,
            auto_follow_ufc_number: 0,
            auto_follow_bjj_number: 0,
            auto_follow_contender_series: false,
            auto_follow_fight_nights: false,
            auto_follow_existing: false,
            clear_search: true,
            show_thumb: true,
            show_duration: true,
            show_desc: true,
